...
The goal of {ROGRSQL} is to provide a basic proof-of-concept for limited DBI-compatibile queries with the [Geospatial Data Abstraction Library (GDAL)](https://gdal.org/) ['OGRSQL'](https://gdal.org/user/ogr_sql_dialect.html) dialect.
